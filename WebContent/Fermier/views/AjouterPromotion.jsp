...
<div class="container mt-4">
    ...
    <form action="produitservlet?action=addPromotion&id_produit=${param.id_produit}&idFermier=${param.idFermier}" method="post">
        <!-- Identifiants cachés -->
        <input type="hidden" name="id_produit" value="${param.id_produit}">
        <input type="hidden" name="idFermier" value="${param.idFermier}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="taux" name="taux" step="0.01" required>
        </div>
        <div class="mb-3">
