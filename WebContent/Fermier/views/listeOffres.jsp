...
<div id="slides-shop" class="cover-slides">
    ...
    <button type="submit" class="btn btn-success btn-sm">Ajouter Produit</button>
</form>
    ...
    <div class="text-center mt-4">
        <a href="${pageContext.request.contextPath}/offreServlet?action=ajouterOffre&idFermier=${idFermier}" class="btn btn-primary">Ajouter une Nouvelle Offre</a>
    </div>
</div>
