...
<div id="slides-shop" class="cover-slides">
    ...
    <div class="container mt-4">
        ...
        <form action="produitservlet?action=ajouterCategorie" method="post">
            <!-- Champ caché pour ID Fermier -->
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description_categorie" name="description_categorie" rows="4" required></textarea>
            </div>
