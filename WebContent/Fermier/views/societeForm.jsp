...
<jsp:include page="sidebar.jsp" />
        ...
        <div class="container">
    <h2><c:out value="${societe != null ? 'Modifier' : 'Ajouter'}" /> une Société de Livraison</h2>
    <form action="Livreur" method="post">
        ...
        <label>Nom:</label>
        <input type="text" name="nom" value="${societe != null ? societe.nom : ''}" required /><br />
        <label>Email:</label>
        <input type="email" name="email" value="${societe != null ? societe.email : ''}" required /><br />
        <label>Login:</label>
        <input type="text" name="login" value="${societe != null ? societe.login : ''}" ${societe != null ? 'disabled' : ''} required /><br />
        <label>Password:</label>
        <input type="password" name="password" ${societe != null ? 'disabled' : ''} required /><br />
        <label>Téléphone:</label>
        <input type="text" name="telephone" value="${societe != null ? societe.telephone : ''}" required /><br />
        <label>Zone Livraison:</label>
        <input type="text" name="zone_livraison" value="${societe != null ? societe.zoneLivraison : ''}" required /><br />
