...
<div class="container mt-4">
    <h1 class="text-center mb-4">Créer une Offre</h1>
    <form action="offreServlet?action=ajouterOffre&idFermier=${idFermier}" method="post">
        <!-- Identifiants cachés -->
        ...
        <div class="mb-3">
            <label for="prixPack" class="form-label">Prix du pack :</label>
            <input type="number" class="form-control" id="prixPack" name="prixPack" step="0.01" required>
        </div>
        <div class="mb-3">
            <label for="tauxReduction" class="form-label">Taux de réduction :</label>
            <input type="number" class="form-control" id="tauxReduction" name="tauxReduction" step="0.01" required>
        </div>
        <div class="mb-3">
        ...
        <div class="text-center">
            <button type="submit" class="btn hvr-hover btn-secondary">Créer l'Offre</button>
        </div>
    </form>
</div>
