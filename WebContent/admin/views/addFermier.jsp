...
<jsp:include page="headerhomme.jsp" />
     ...
     <div class="container mt-4">
        ...
        <h1 class="text-center mb-4">Ajouter un Nouveau Fermier</h1>
        
        <!-- Formulaire pour ajouter un fermier -->
        <form action="${pageContext.request.contextPath}/fermiers" method="post" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="address" name="address" class="form-control" placeholder="Adresse complète" required>
            </div>

            <!-- Type de Fermier -->
            <div class="col-md-12">
                <label for="typeFermies" class="form-label">Type de Fermier</label>
                <input type="text" id="typeFermies" name="typeFermies" class="form-control" placeholder="Type de fermier (ex: agricole, éleveur)" required>
            </div>

            <!-- Boutons -->
            <div class="col-12 text-center mt-4">
                <button type="submit" class="hvr-hover btn-secondary">Ajouter Fermier</button>
