     ...
     <div class="container mt-4">
      ...
      <c:if test="${empty fermiers}">
                    ...
                    <tbody>
                        <c:forEach var="fermier" items="${fermiers}">
                            <tr>
                                ...
                                <td>
                                    <a href="fermiers?action=edit&id=${fermier.id}" class="btn btn-warning btn-sm">Modifier</a>
        ...
        <div class="text-center mt-4">
            <a href="fermiers?action=add" class="btn btn-success">Ajouter un Fermier</a>
        </div>
    </div>
