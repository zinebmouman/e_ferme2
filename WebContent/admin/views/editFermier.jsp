...
<jsp:include page="headerhomme.jsp" />
  ...
  <div class="container mt-4">
        <h1 class="text-center mb-4">Modifier les informations du Fermier</h1>

        <!-- Formulaire de modification -->
        <form action="${pageContext.request.contextPath}/fermiers" method="post" class="row g-3">
            <!-- Champs cachés -->
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="nom" name="nom" class="form-control" value="${fermier.nom}" required>
            </div>

            <!-- Email -->
            <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="email" id="email" name="email" class="form-control" value="${fermier.email}" required>
            </div>

            <!-- Login -->
            <div class="col-md-6">
                <label for="login" class="form-label">Nom d'utilisateur</label>
                <input type="text" id="login" name="login" class="form-control" value="${fermier.login}" required>
            </div>

            <!-- Mot de passe -->
            <div class="col-md-6">
                <label for="password" class="form-label">Mot de passe</label>
                <input type="password" id="password" name="password" class="form-control" value="${fermier.password}" required>
            </div>

            <!-- Téléphone -->
            <div class="col-md-6">
                <label for="telephone" class="form-label">Téléphone</label>
                <input type="text" id="telephone" name="telephone" class="form-control" value="${fermier.telephone}" required>
            </div>

            <!-- Adresse -->
            <div class="col-md-6">
                <label for="address" class="form-label">Adresse</label>
                <textarea id="address" name="address" rows="3" class="form-control" required>${fermier.address}</textarea>
            </div>

            <!-- Type Fermier -->
            <div class="col-md-12">
                <label for="typeFermies" class="form-label">Type de Fermier</label>
                <input type="text" id="typeFermies" name="typeFermies" class="form-control" value="${fermier.typeFermies}" required>
            </div>

            <!-- Boutons -->
            <div class="col-12 text-center mt-4">
                <button type="submit" class="hvr-hover btn-secondary">Enregistrer</button>
                <a href="${pageContext.request.contextPath}/fermiers?action=list" class="hvr-hover btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
