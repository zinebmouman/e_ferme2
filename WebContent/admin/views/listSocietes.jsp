...
<div id="slides-shop" class="cover-slides">
                ...
                <tbody>
                    <c:forEach var="societe" items="${societes}">
                        <tr>
                            ...
                            <td>
                                <a href="Livreur?action=edit&id=${societe.id}" class="btn btn-warning btn-sm">Modifier</a>
    ...
    <div class="text-center mt-4">
        <a href="Livreur?action=add" class="btn btn-success">Ajouter une Nouvelle Société</a>
    </div>
</div>
