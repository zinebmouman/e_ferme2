        ...
        <c:forEach var="produit" items="${produitsAvecPromotion}" varStatus="status">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    ...
                    <a class="btn hvr-hover" href="${pageContext.request.contextPath}/Client/views/Login.jsp">${produit.nom}<br>${produit.promotion.taux}% de réduction</a>
                  <!--   <div class="card-body">
...
<div id="offres-section" class="box-add-products">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="offer-section">
                                    	 <a href="${pageContext.request.contextPath}/Client/views/Login.jsp" class="btn hvr-hover">Voir l'offre</a>
    ...
    <button class="active" type="submit" name="idc" value="0" data-page="index">All</button> <!-- All products button -->
    <c:forEach var="categorie" items="${categories}">
        <!-- Submit button for each category -->
        <button class="btn hvr-hover" type="submit" name="idc" value="${categorie.idCategorie}" class="btn" data-toggle="tooltip" title="${categorie.nom}" data-page="index">
            ${categorie.nom}
        </button>
    </c:forEach>
</form>
            ...
            <div class="products-single fix">
                <div class="box-img-hover">
                    ...
                    <div class="mask-icon">
                        ...
                        <a class="cart" href="${pageContext.request.contextPath}/Client/views/Login.jsp">Add to Cart</a>
                    </div>
                </div>
                <div class="why-text">
...
.img-equal-size2 {
    ...
    $(document).ready(function(){
        $('#produitsSlider').carousel({
            interval: 3000 // Défilement toutes les 2 secondes
        });
    });
