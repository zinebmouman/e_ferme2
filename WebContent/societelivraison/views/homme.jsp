                ...
                <c:forEach var="produit" items="${produitsAvecPromotion}" varStatus="status">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <form action="${pageContext.request.contextPath}/PanierServlet" method="post">
                            ...
                            <input type="hidden" name="promotion_id" value="${produitPromotionMap[produit.idProduit]}"> <!-- Envoie le promotion_id correspondant au produit -->
                            <input type="hidden" name="quantite" value="1">
                            <input type="hidden" name="prix" value="${produit.prix * (1 - produit.promotion.taux / 100)}"> <!-- Prix après réduction -->
                            <button type="submit" class="btn btn-danger hvr-hover">Add to Cart</button>
                        </form>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="offer-section">
                                    	 <a href="${pageContext.request.contextPath}/offreDetail?user_id=${param.user_id}&offreId=${offres[i + 1].idOffre}" class="btn btn-danger hvr-hover">Voir l'offre</a>
